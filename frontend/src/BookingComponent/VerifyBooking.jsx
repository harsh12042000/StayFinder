...
const VerifyBooking = () => {
  ...
  const retrieveAllBookingStatus = async () => {
    const response = await axios.get(
      "http://localhost:8081/api/book/hotel/fetch/status"
    );
  ...
  const retrieveBooking = async () => {
    const response = await axios.get(
      "http://localhost:8081/api/book/hotel/fetch/id?bookingId=" + bookingId
    );
  ...
  const updateHotelBookingStatus = (e) => {
    ...
    fetch("http://localhost:8081/api/book/hotel/update/status", {
      method: "POST",
      headers: {
